...
public abstract class GameObject {
	...
	public GameObject(int x, int y, BufferedImage img, ID ID, LoadedTextures LT) {
		this.LT = LT;
	...
	public GameObject(int x, int y, BufferedImage img, double boundpos, ID ID, LoadedTextures LT) {
		this.LT = LT;
		setStart(x, y, img.getWidth(), img.getHeight(), ID);
	...
	public GameObject(int x, int y, int width, int height, ID ID, LoadedTextures LT) {
		this.LT = LT;
	...
	private void setStart(int x, int y, int width, int height, ID ID) {
		this.x = x;
		this.y = y;
		this.width = width;
		this.height = height;
